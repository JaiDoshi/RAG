...
class RAGModel:
    def __init__(self):
        ...
        Based on the question and references below, answer the question in short (less than 30 words). Respond with 'I don't know' if the references are not sufficient to answer the question
        ### Question
        {query}
