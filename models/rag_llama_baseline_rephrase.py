...
class RAGModel:
    def __init__(self):
        ...
        model_name = "meta-llama/Meta-Llama-3-8B-Instruct" # "models/meta-llama/Llama-2-7b-chat-hf"
    ...
    def generate_answer(self, query: str, search_results: List[Dict]) -> str:
        ...
        Output Query: Who was the director for "From Russia with Love"  
        ...
        messages1 = [
            {"role": "system", "content": """
            You are an AI assistant tasked with generating well-formed questions from given examples. The output questions should be capitalized, have proper punctuation, and include quotation marks around any proper nouns or titles. You can rephrase the question for better understanding, but the grammar should be correct and meaning of the question should remain unchanged.
             """},
        ...
        final_prompt = self.prompt_template.format(
            query=answer1, references=references
        )
        messages = [
